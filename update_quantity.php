...
if (isset($_POST['quantity']) && isset($_POST['productName'])) {
...
if (isset($_SESSION['username'])) {
    ...
    $updateSql = "UPDATE shopping_cart SET Quantity = '$newQuantity' WHERE UserID = '$userID' AND Product_Name = '$productName'";
