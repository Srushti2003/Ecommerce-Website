...
<body>
    ...
    <div class="horizontal-panel">
            ...
            <button class="category-btn" data-category="Outer Wear">Outer Wear</button>
            <button class="category-btn" data-category="Active Wear">Active Wear</button>
            ...
            <button class="category-btn" data-category="Ethnic Tops">Ethnic Tops</button>
            ...
            <button class="category-btn" data-category="Indo-Western Outfits">Indo-Western Outfits</button>
        </div>
      ...
      <?php
        ...
        if (isset($_GET['category'])) {
          ...
          $sql = "SELECT * FROM products_data WHERE Category_Name = '$category' AND Gender = 'Girl'";
        } else {
          $sql = "SELECT * FROM products_data WHERE Product_Type = 'Girls_Clothing' AND Gender = 'Girl'";
        }
...
function display(category){
    window.location.href = 'girls_wear.php?category=' + category;
}
