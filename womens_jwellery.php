...
<body>
    ...
    <div class="horizontal-panel">
            ...
            <button class="category-btn" data-category="Anklets">Anklets</button>
      ...
      <?php
        ...
        if (isset($_GET['category'])) {
          ...
          $sql = "SELECT * FROM products_data WHERE Product_Type = 'Womens_Jwellery' AND Gender = 'Women'";
        }
...
function display(category){
    window.location.href = 'womens_jwellery.php?category=' + category;
}
