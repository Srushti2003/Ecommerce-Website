...
<head>
  ...
  <link rel="stylesheet" href="mens_foot_css.css">
...
<body>
    ...
    <main>
        <div class="horizontal-panel">
            <button class="category-btn" data-category="Casual Shoes">Casual Shoes</button>
            <button class="category-btn" data-category="Dress Shoes">Dress Shoes</button>
            <button class="category-btn" data-category="Boots">Boots</button>
            <button class="category-btn" data-category="Sandals and Flip-Flops">Sandals and Flip-Flops</button>
            <button class="category-btn" data-category="Athletic Shoes">Athletic Shoes</button>
            <button class="category-btn" data-category="Slippers and House Shoes">Slippers and House Shoes</button>
            <button class="category-btn" data-category="Specialty Footwear">Specialty Footwear</button>
            <button class="category-btn" data-category="Ethnic and Traditional Footwear">Ethnic and Traditional Footwear</button>
            <button class="category-btn" data-category="Outdoor and Adventure Footwear">Outdoor and Adventure Footwear</button>
            <button class="category-btn" data-category="Fashion and Statement Footwear">Fashion and Statement Footwear</button>
        </div>
      ...
      <?php
        ...
        if (isset($_GET['category'])) {
          ...
          $sql = "SELECT * FROM products_data WHERE Product_Type = 'Mens_FootWear' AND Gender = 'Men'";
        }
...
function display(category){
    window.location.href = 'mens_footwear.php?category=' + category;
}
