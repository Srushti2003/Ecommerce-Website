...
<body>
    ...
    <div class="horizontal-panel">
            ...
            <button class="category-btn" data-category="Ethnic Outfits">Ethnic Outfits</button>
      ...
      <?php
        ...
        if (isset($_GET['category'])) {
          ...
          $sql = "SELECT * FROM products_data WHERE Category_Name = '$category' AND Gender = 'Boy'";
        } else {
          $sql = "SELECT * FROM products_data WHERE Product_Type = 'Boys_Clothing' AND Gender = 'Boy'";
        }
...
function display(category){
    window.location.href = 'boys_wear.php?category=' + category;
}
