...
<head>
  ...
  <link rel="stylesheet" href="womens_foot_css.css">
    ...
    <main>
      ...
      <?php
        ...
        if (isset($_GET['category'])) {
          ...
          $sql = "SELECT * FROM products_data WHERE Category_Name = '$category' AND Gender = 'Women'";
        } else {
          $sql = "SELECT * FROM products_data WHERE Product_Type = 'Womens_FootWear' AND Gender = 'Women'";
        }
...
function display(category){
    window.location.href = 'womens_footwear.php?category=' + category;
}
