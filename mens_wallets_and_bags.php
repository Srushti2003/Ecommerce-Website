...
<body>
    ...
    <main>
        <div class="horizontal-panel">
            <button class="category-btn" data-category="Bifold Wallet">Bifold Wallet</button>
            <button class="category-btn" data-category="Trifold Wallet">Trifold Wallet</button>
            <button class="category-btn" data-category="Money Clip Wallet">Money Clip Wallet</button>
            <button class="category-btn" data-category="Cardholder">Cardholder</button>
            <button class="category-btn" data-category="Travel Wallet">Travel Wallet</button>
            <button class="category-btn" data-category="Briefcase">Briefcase</button>
            <button class="category-btn" data-category="Messenger Bag">Messenger Bag</button>
            <button class="category-btn" data-category="Backpack">Backpack</button>
            <button class="category-btn" data-category="Duffle Bag">Duffle Bag</button>
            <button class="category-btn" data-category="Portfolio Bag">Portfolio Bag</button>
        </div>
      ...
      <?php
        ...
        if (isset($_GET['category'])) {
          ...
          $sql = "SELECT * FROM products_data WHERE Product_Type = 'Mens_Wallets_Bags' AND Gender = 'Men'";
        }
...
function display(category){
    window.location.href = 'mens_wallets_and_bags.php?category=' + category;
}
