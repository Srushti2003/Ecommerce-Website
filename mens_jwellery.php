...
<body>
    ...
    <div class="horizontal-panel">
            <button class="category-btn" data-category="Neck Accessories">Neck Accessories</button>
            <button class="category-btn" data-category="Ear Accessories">Ear Accessories</button>
            ...
            <button class="category-btn" data-category="Brooches and Pins">Brooches and Pins</button>
        </div>
      ...
      <?php
        ...
        if (isset($_GET['category'])) {
          ...
          $sql = "SELECT * FROM products_data WHERE Product_Type = 'Mens_Jwellery' AND Gender = 'Men'";
        }
...
function display(category){
    window.location.href = 'mens_jwellery.php?category=' + category;
}
