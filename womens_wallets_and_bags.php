...
<body>
    ...
    <main>
        ...
        <button class="category-btn" data-category="Clutch Wallet">Clutch Wallet</button>
            <button class="category-btn" data-category="Zip-Around Wallet">Zip-Around Wallet</button>
            <button class="category-btn" data-category="Wristlet">Wristlet</button>
            <button class="category-btn" data-category="Coin Purse">Coin Purse</button>
            <button class="category-btn" data-category="Checkbook Wallet">Checkbook Wallet</button>
            <button class="category-btn" data-category="Tote Bag">Tote Bag</button>
            <button class="category-btn" data-category="Shoulder Bag">Shoulder Bag</button>
            <button class="category-btn" data-category="Crossbody Bag">Crossbody Bag</button>
            <button class="category-btn" data-category="Satchel">Satchel</button>
            <button class="category-btn" data-category="Hobo Bag">Hobo Bag</button>
        </div>
      ...
      <?php
        ...
        if (isset($_GET['category'])) {
          ...
          $sql = "SELECT * FROM products_data WHERE Product_Type = 'Womens_Wallets_Bags' AND Gender = 'Women'";
        }
...
function display(category){
    window.location.href = 'womens_wallets_and_bags.php?category=' + category;
}
