...
<body>
    ...
    <main>
        <div class="horizontal-panel">
            ...
            <button class="category-btn" data-category="Ethnic Dresses">Ethnic Dresses</button>
            <button class="category-btn" data-category="Kurtas_or_Kurtis">Kurtas/Kurtis</button>
            <button class="category-btn" data-category="Ethinic Bottoms">Ethinic Bottoms</button>
            <button class="category-btn" data-category="Dupattas">Dupattas</button>
            <button class="category-btn" data-category="Ethnic Jackets">Ethnic Jackets</button>
            <button class="category-btn" data-category="Indo-Western Dresses">Indo-Western Dresses</button>
            <button class="category-btn" data-category="Wedding Wear">Wedding Wear</button>
            <button class="category-btn" data-category="Party Wear">Party Wear</button>
        </div>
      ...
      <?php
        ...
        if (isset($_GET['category'])) {
          ...
          $sql = "SELECT * FROM products_data WHERE Product_Type = 'Womens_Clothing' AND Gender = 'Women'";
        }
...
function display(category){
    window.location.href = 'womens_wear.php?category=' + category;
}
